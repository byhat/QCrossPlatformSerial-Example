...
public class SerialInputOutputManager implements Runnable {
    ...
    public void setReadTimeout(int timeout) {
        // when set if already running, read already blocks and new value will not become effective now
     ...
     * else, write will be delayed until read data is available
     */
    ...
    /**
     * Continuously services of read and write buffers until {@link #stop()} is
